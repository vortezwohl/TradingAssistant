            ...
            rx.hstack(
                rx.vstack(
                    ...
                    rx.text(
                        ...
                        style={**compact_label_style(), "font_size": "10px"},
                    ),
                    spacing="1",
                    align="start",
                ),
                ...
                rx.foreach(
                    ...
                    lambda item: rx.hstack(
                        ...
                        rx.text(
                            ...
                            style={
                                **mono_value_style(
                                    color=_tone_color_expr(item["tone"])
                                ),
                                "font_size": "12px",
                            },
                        ),
    ...
    return rx.button(
        rx.grid(
            rx.vstack(
                rx.text(
                    row["code"],
                    style={**mono_value_style(size="12px"), "width": "100%"},
                ),
            ...
            rx.text(
                ...
                style={
                    **mono_value_style(
                        color=_tone_color_expr(row["tone"]), size="12px"
                    ),
                    "text_align": "right",
                    "width": "100%",
                    "overflow": "hidden",
        ...
        style={
            ...
            "box_shadow": rx.cond(
                row["active"],
                f"inset 2px 0 0 {TRADING_COLORS['amber']}",
...
def _chart_hover_panel() -> rx.Component:
    ...
    return rx.box(
        rx.hstack(
            rx.text(
                details["slot"],
                style={**compact_label_style(), "color": TRADING_COLORS["amber"]},
            ),
            rx.spacer(),
            rx.text(
                details["change"],
                style={
                    **mono_value_style(
                        color=_tone_color_expr(details["tone"]), size="11px"
                    ),
                    "text_align": "right",
                },
            ),
        ...
        rx.grid(
            rx.box(
                rx.text("Open", style=compact_label_style()),
                rx.text(
                    details["open"],
                    style={**mono_value_style(size="11px"), "margin_top": "3px"},
                ),
            ),
            rx.box(
                rx.text("High", style=compact_label_style()),
                rx.text(
                    details["high"],
                    style={**mono_value_style(size="11px"), "margin_top": "3px"},
                ),
            ...
            rx.box(
                rx.text("Low", style=compact_label_style()),
                rx.text(
                    details["low"],
                    style={**mono_value_style(size="11px"), "margin_top": "3px"},
                ),
            ...
            rx.box(
                rx.text("Close", style=compact_label_style()),
                rx.text(
                    details["close"],
                    style={**mono_value_style(size="11px"), "margin_top": "3px"},
                ),
        ...
        rx.grid(
            rx.box(
                rx.text("Volume", style=compact_label_style()),
                rx.text(
                    details["volume"],
                    style={**mono_value_style(size="11px"), "margin_top": "3px"},
                ),
            ...
            rx.box(
                rx.text("Delta", style=compact_label_style()),
                rx.text(
                    details["delta"],
                    style={
                        **mono_value_style(
            ...
            rx.box(
                rx.text("VWAP Gap", style=compact_label_style()),
                rx.text(
                    details["vwap_gap"],
                    style={**mono_value_style(size="11px"), "margin_top": "3px"},
                ),
            ...
            rx.box(
                rx.text("Route", style=compact_label_style()),
                rx.text(
                    details["route"],
                    style={**mono_value_style(size="11px"), "margin_top": "3px"},
                ),
        ...
        rx.box(
            rx.text(
                details["route_description"],
                style={
                    **truncated_text_style(size="10px"),
                    "white_space": "normal",
                    "line_height": "1.35",
                },
            ),
            ...
            rx.foreach(
                ...
                lambda row: rx.hstack(
                    ...
                    rx.text(
                        ...
                        style={
                            **mono_value_style(
                                color=_tone_color_expr(row["tone"]), size="11px"
                            )
                        },
                    ),
                    width="100%",
        ...
        style={
            **hover_panel_style(),
            "left": WatchPageState.chart_hover_card_left,
            "transform": WatchPageState.chart_hover_card_transform,
        },
    )
...
def _watchlist_panel() -> rx.Component:
    return rx.box(
        rx.box(
            ...
            rx.button(
                WatchPageState.sort_button_label,
                on_click=WatchPageState.toggle_sort_mode,
                style={
                    **terminal_button_style(
                        height="30px", padding="0 10px", tone="text_soft"
                    ),
                    "color": TRADING_COLORS["text_soft"],
                },
            ),
        ...
        rx.vstack(
            rx.form(
                rx.hstack(
                    rx.input(
                        name="code",
                        placeholder="Add code: US.NVDA",
                        value=WatchPageState.ticker_input,
                        on_change=WatchPageState.set_ticker_input,
                        style=input_style(),
                        width="100%",
                    ),
                    rx.button(
                        ...
                        type="submit",
                        style={
                            **terminal_button_style(height="30px", padding="0 12px"),
            ...
            rx.box(
                rx.foreach(WatchPageState.watchlist_rows, _watchlist_row),
...
def _movers_panel() -> rx.Component:
    return rx.box(
        rx.box(
            ...
            rx.hstack(
                rx.foreach(
                    charting.MOVERS_TABS,
                    lambda item: rx.button(
                        item[1],
                        on_click=lambda: WatchPageState.set_movers_tab(item[0]),
                        style={
                            **terminal_button_style(tone="text_soft"),
                            "border": rx.cond(
                                WatchPageState.movers_tab == item[0],
                                f"1px solid {TRADING_COLORS['line_strong']}",
                                f"1px solid {TRADING_COLORS['line']}",
                            ),
                            "background": rx.cond(
                                WatchPageState.movers_tab == item[0],
                                TRADING_COLORS["surface_panel_alt"],
                                TRADING_COLORS["surface_panel"],
                            ),
                            "color": rx.cond(
                                WatchPageState.movers_tab == item[0],
                                TRADING_COLORS["amber"],
                                TRADING_COLORS["text_soft"],
                            ),
                        },
                    ),
                ),
...
def _snapshot_panel() -> rx.Component:
    return rx.box(
        rx.box(
            ...
            rx.text("Cross Asset Pulse", style=compact_label_style()),
            style=panel_head_style(),
        ),
        rx.grid(
            rx.foreach(
                ...
                lambda cell: rx.box(
                    rx.text(
                        cell["label"],
                        style=truncated_text_style(
                            size="10px", color=TRADING_COLORS["text_dim"]
                        ),
                    ),
                    rx.text(
                        cell["value"],
                        style={
                            **mono_value_style(size="16px"),
                            "margin_top": "6px",
                            "width": "100%",
                            "overflow": "hidden",
                            "text_overflow": "ellipsis",
                    ...
                    rx.text(
                        ...
                        style={
                            **truncated_text_style(
                                size="10px", color=TRADING_COLORS["text_soft"]
                            ),
                            "margin_top": "5px",
                        },
                    ),
...
def _left_column() -> rx.Component:
    return rx.box(
        ...
        _snapshot_panel(),
        style=column_style(
            rows="minmax(0, 1.12fr) minmax(0, 0.9fr) 214px",
    ...
    return rx.box(
        rx.hstack(
            rx.hstack(
                rx.vstack(
                    rx.heading(
                        WatchPageState.instrument_name,
                        size="6",
                        style={
                            "font_size": "25px",
                            "line_height": "1",
                    ...
                    rx.text(
                        WatchPageState.instrument_meta,
                        style={
                            **compact_label_style(),
                            "font_size": "11px",
                            "margin_top": "7px",
                ...
                rx.hstack(
                    rx.text(
                        WatchPageState.last_price_text,
                        style={
                            **mono_value_style(
                                color=WatchPageState.price_change_color, size="30px"
                            ),
                            "letter_spacing": "0.02em",
                        },
                    ),
                    rx.text(
                        WatchPageState.price_change_text,
                        style={
                            **mono_value_style(
                                color=WatchPageState.price_change_color, size="14px"
                            )
                        },
                    ),
                    spacing="3",
            ...
            rx.grid(
                rx.foreach(
                    WatchPageState.instrument_metrics,
                    lambda metric: rx.box(
                        rx.text(metric["label"], style=compact_label_style()),
                        rx.text(
                            metric["value"],
                            style={
                                **mono_value_style(size="13px"),
                                "margin_top": "6px",
                            },
                        ),
                        padding="7px 10px",
                        border_left=f"1px solid {TRADING_COLORS['line']}",
                    ),
                ),
                columns="6",
                width="520px",
...
def _control_row(
    items: list[tuple[str, str]], active_value: rx.Var[str], on_click
) -> rx.Component:
    return rx.hstack(
        rx.foreach(
            items,
            lambda item: rx.button(
                item[1],
                on_click=lambda: on_click(item[0]),
                style={
                    **terminal_button_style(tone="text_soft"),
                    "border": rx.cond(
                        active_value == item[0],
...
def _overlay_row() -> rx.Component:
    return rx.hstack(
        rx.foreach(
            [(item, item) for item in charting.OVERLAY_OPTIONS],
            lambda item: rx.button(
                item[1],
                on_click=lambda: WatchPageState.toggle_overlay(item[0]),
                style={
                    **terminal_button_style(tone="text_soft"),
                    "border": rx.cond(
                        WatchPageState.active_overlays.contains(item[0]),
                        f"1px solid {TRADING_COLORS['line_strong']}",
                        f"1px solid {TRADING_COLORS['line']}",
                    ),
                    "background": rx.cond(
    ...
    return rx.box(
        rx.box(
            rx.hstack(
                ...
                rx.text(
                    WatchPageState.chart_status_label,
                    style={**compact_label_style(), "color": TRADING_COLORS["amber"]},
                ),
                rx.spacer(),
                rx.hstack(
                    rx.foreach(
                        ...
                        lambda item: rx.text(
                            ...
                            style={
                                **mono_value_style(
                                    color=_tone_color_expr(item["tone"]), size="11px"
                                ),
                                "white_space": "nowrap",
                            },
                        ),
        ...
        rx.box(
            rx.box(
                rx.html(WatchPageState.primary_chart_svg),
                width="100%",
                height="100%",
                position="absolute",
                inset="0",
            ...
            rx.box(
                ...
                top="0",
                bottom="0",
                left=WatchPageState.chart_hover_line_left,
                width="1px",
                background=rx.cond(
                    WatchPageState.hover_active, TRADING_COLORS["amber"], "transparent"
                ),
                opacity="0.7",
                z_index="3",
            ...
            rx.box(
                ...
                inset="0",
                z_index="5",
                on_mouse_leave=WatchPageState.clear_hover_index,
            ),
            width="100%",
            height="100%",
            position="relative",
        ...
        rx.grid(
            rx.foreach(
                WatchPageState.chart_footer_labels,
                lambda label: rx.box(
                    label,
                    display="flex",
                    align_items="center",
...
def _study_strip() -> rx.Component:
    return rx.box(
        rx.hstack(
            rx.text(WatchPageState.study_title, style=compact_label_style()),
            rx.spacer(),
            rx.text(WatchPageState.study_summary, style=compact_label_style()),
            width="100%",
            padding="0 12px",
            height="32px",
            border_bottom=f"1px solid {TRADING_COLORS['line']}",
                    ...
                    rx.hstack(
                        ...
                        rx.vstack(
                            rx.text(
                                ...
                                style={
                                    **mono_value_style(
                                        color=_tone_color_expr(card["tone"]),
                                        size="12px",
                                    )
                                },
                            ),
        ...
        style=panel_style(
            rows="32px minmax(0, 1fr)", background="#091017", border_bottom=False
        ),
    )
                ...
                rx.foreach(
                    ...
                    lambda item: rx.button(
                        ...
                        style={
                            **terminal_button_style(tone="text_soft"),
                            "border": rx.cond(
                                WatchPageState.depth_mode == item[0],
                                f"1px solid {TRADING_COLORS['line_strong']}",
                                f"1px solid {TRADING_COLORS['line']}",
                            ),
                            "background": rx.cond(
                ...
                rx.foreach(
                    ...
                    lambda row: rx.grid(
                        rx.text(
                            ...
                            style={
                                **mono_value_style(
                                    color=TRADING_COLORS["red"], size="11px"
                                ),
                                "text_align": "right",
                            },
                        ),
                        ...
                        rx.text(
                            ...
                            style={
                                **mono_value_style(
                                    color=TRADING_COLORS["text_soft"], size="11px"
                                ),
                                "text_align": "center",
                            },
                        ),
                        rx.text(
                            ...
                            style={
                                **mono_value_style(
                                    color=TRADING_COLORS["green"], size="11px"
                                ),
                                "text_align": "right",
                            },
                        ),
            ...
            lambda card: rx.box(
                ...
                rx.grid(
                    rx.box(
                        rx.text(
                            card["metric_1_label"],
                            style={**compact_label_style(), "font_size": "9px"},
                        ),
                        rx.text(
                            card["metric_1_value"],
                            style={
                                **mono_value_style(size="11px"),
                                "margin_top": "4px",
                            },
                        ),
                        padding="6px 8px",
    ...
    return rx.box(
        rx.foreach(
            ...
            lambda row: rx.grid(
                ...
                rx.text(
                    row["size"],
                    style={**mono_value_style(size="11px"), "text_align": "right"},
                ),
                rx.text(
                    row["time"],
                    style={
            ...
            rx.box(
                ...
                rx.hstack(
                    rx.foreach(
                        ...
                        lambda item: rx.button(
                            item[1],
                            on_click=lambda: WatchPageState.set_rail_tab(item[0]),
                            style={
                                **terminal_button_style(tone="text_soft"),
                                "border": rx.cond(
                                    WatchPageState.rail_tab == item[0],
                                    f"1px solid {TRADING_COLORS['line_strong']}",
                                    f"1px solid {TRADING_COLORS['line']}",
                                ),
                                "background": rx.cond(
...
def index() -> rx.Component:
    ...
    return rx.box(
        _top_bar(),
        rx.box(
            _left_column(), _center_column(), _right_column(), style=workspace_style()
        ),
        style=shell_style(),
    )
