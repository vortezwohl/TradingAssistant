"""Frontend charting module compatibility re-export layer.

This file re-exports all public symbols from four sub-modules (models, studies,
renders, utils), keeping existing import paths in `app.py` and `state.py` unchanged.
"""
